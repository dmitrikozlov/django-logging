...
class LoggerWithExtra(logging.Logger):
    ...
    def notice(self, msg, *args, **kwargs):
        super().log(py_label_to_level['NOTICE'], msg, *args,
            extra={"json_fields":kwargs}, stacklevel=2)
    ...
    def alert(self, msg, *args, **kwargs):
        super().log(py_label_to_level['ALERT'], msg, *args,
            extra={"json_fields":kwargs}, stacklevel=2)
    def emergency(self, msg, *args, **kwargs):
        super().log(py_label_to_level['EMERGENCY'], msg, *args,
            extra={"json_fields":kwargs}, stacklevel=2)
